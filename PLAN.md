...
- [x] **国际化支持 (i18n)**：实现了完整的中英文界面切换，涵盖导航、右键菜单、过滤器、相册视图及属性编辑器。
...
- v2.4: (2026-03-16) **国际化与视觉对齐升级**。引入了基于 JSON 驱动的翻译系统，完成了全界面 (含深度右键嵌套菜单与属性编辑窗) 的中英双语覆盖，并修复了 Vite 开发环境下的 JSON 热更新机制与翻译函数容错性。
